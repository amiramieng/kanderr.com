...
require get_template_directory() . '/vendor/Mobile_Detect.php';
...
class Kanderr extends Theme {
	...
	public function __construct() {
		...
		->addScript( 'mobile-detect', get_template_directory_uri() . '/js/lib/mobile-detect.min.js' )
		...
		->addFilter( 'get_image_tag_class', array( $this ), 'image_tag_class' );
	}
	...
	public function image_tag_class( $class ) {
