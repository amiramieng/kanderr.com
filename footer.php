			...
			<footer class="footer" role="contentinfo">
				<div class="container row footer-inner">
					...
					<div class="col-md-4 contact">
						<h3>Contact Us</h3>
						<form novalidate id="contact-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
					    ...
					    <div class="form-group">
					      <textarea class="form-control" placeholder="Your message..." id="message" name="message" maxlength="500"></textarea>
					    ...
					    <div class="row mt-3">
					      ...
					      <div class="col-xs-9">
					        ...
					        <small class="text-danger form-control-msg js-form-error">There was an issue contacting Kanderr, please try again.</small>
					      </div>
					    </div>
					  </form>
					</div>
					...
					<div class="col-md-4">
						...
						<!-- copyright -->
						<p class="copyright">
							&copy; <?php echo date('Y'); ?> Copyright <?php bloginfo('name'); ?>. <?php _e('Designed and developed by', 'html5blank'); ?>
